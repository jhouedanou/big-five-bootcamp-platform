            ...
            <main className="flex-1">
                ...
                <section className="relative py-20 lg:py-32 overflow-hidden bg-gradient-to-b from-[#F5F5F5] to-white">
                    ...
                    <div className="container relative mx-auto px-4 text-center">
                        ...
                        <h1 className="font-[family-name:var(--font-heading)] text-4xl lg:text-6xl font-extrabold tracking-tight mb-6 text-[#0F0F0F]">
                            Inspirer la créativité <br /> <span className="text-[#F2B33D]">Africaine</span>
                        </h1>
                                               <p className=" text-lg text-[#0F0F0F]/70 pt-4 text-center">
                    ...
                    <div className="container mx-auto px-4">
                        <div className="grid md:grid-cols-3 gap-8">
                            {[
                                ...
                                <div key={i} className="p-8 rounded-2xl border border-[#F5F5F5] bg-white hover:shadow-lg transition-all">
                                    <div className="h-12 w-12 rounded-lg bg-[#F2B33D]/10 flex items-center justify-center text-[#F2B33D] mb-6">
                                        <item.icon className="h-6 w-6" />
                                    </div>
                                    <h3 className="text-xl font-bold mb-3 text-[#0F0F0F]">{item.title}</h3>
                                    <p className="text-[#0F0F0F]/70">{item.desc}</p>
                                </div>
                            ))}
                        </div>
                    </div>
