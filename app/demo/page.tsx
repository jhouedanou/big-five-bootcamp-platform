...
export default function DemoPage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-background via-background to-muted/20 relative">
      <ParticlesBackground color="#FF6B35" particleCount={30} />
      <div className="relative z-10">
        <DashboardNavbar />

        <div className="mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8">
          {/* Section de filtres avancés style Adforum */}
          <div className="mb-8 bg-white/50 dark:bg-card/50 backdrop-blur-sm rounded-2xl p-6 border border-border shadow-sm">
            <AdvancedFilters
          ...
          {paginatedContent.length === 0 && (
            <div className="flex flex-col items-center justify-center py-16 text-center">
              ...
              <h3 className="font-[family-name:var(--font-montserrat)] text-xl font-semibold text-foreground">
